---
title: "Entidade 3"
api: "GET /api/v1/bmg/3/ofertas/cpf/:cpf/matricula/:matricula"
description: "Consulta ofertas para a entidade 3"
---

## Endpoint

<Endpoint method="get" url="/api/v1/bmg/3/ofertas/cpf/:cpf/matricula/:matricula" />
